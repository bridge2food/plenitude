...
const Schedule = () => {
  ...
  return (
    <section className="schedule pb-16 pt-[160px]">
      <div className="container">
        ...
        {scheduleList.map((item, index) => (
          <div className="mb-10 grid grid-cols-1 gap-12 lg:grid-cols-2" key={index}>
            <div>
              <h3 className="mb-5 text-[32px] font-semibold"> {item.title} </h3>
              <p className="text-lg"> {item.details} </p>
            </div>
            <div>
              <h3 className="mb-6 text-[32px] font-semibold">
              ...
              <div className="grid grid-cols-2 gap-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {item.scheduleAuthor.map((author, index) => (
                  <div key={index}>
                    ...
                    />
                    <div className="">
                      <h3 className="text-base font-medium">{author.memberName}</h3>
